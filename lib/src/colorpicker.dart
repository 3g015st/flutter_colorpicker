...
class ColorPicker extends StatefulWidget {
  const ColorPicker({
    ...
    this.controlsAreaHeightPercent = 0.55,
  ...
  final double controlsAreaHeightPercent;
...
class _ColorPickerState extends State<ColorPicker> {
  ...
  Widget build(BuildContext context) {
    if (MediaQuery.of(context).orientation == Orientation.portrait ||
        widget.portraitOnly) {
      List<Widget> sliderBoxWidgetsList = [];

      if (widget.showColorIndicator) {
        sliderBoxWidgetsList.add(GestureDetector(
          onTap: () => setState(() {
      ...
      double offsetWidthSlider = !widget.showColorIndicator ? 0.0 : 75.0;
      double paddingLRSliderBoxWidgetsList =
          !widget.showColorIndicator ? 0.0 : 15.0;

      sliderBoxWidgetsList.add(Expanded(
        child: Column(
          children: <Widget>[
            SizedBox(
                height: 40.0,
                width: widget.colorPickerWidth - offsetWidthSlider,
      ...
      return Column(
        children: <Widget>[
          ...
          SizedBox(
            width: widget.colorPickerWidth,
            height: widget.colorPickerWidth * widget.controlsAreaHeightPercent,
            child: Column(
              children: [
                Padding(
                  padding: EdgeInsets.fromLTRB(paddingLRSliderBoxWidgetsList,
                      5.0, paddingLRSliderBoxWidgetsList, 5.0),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: sliderBoxWidgetsList,
                  ),
                ),
      ...
      if (widget.showColorIndicator) {
        sliderBoxWidgetsList.add(const SizedBox(width: 20.0));
      ...
      sliderBoxWidgetsList.add(Column(
        children: <Widget>[
      ...
      sliderBoxWidgetsList.add(const SizedBox(width: 10.0));
